    ...
    <>
      ...
      {showContent && (
        <div className="main w-full h-full rotate-[-10deg] scale-[1.7] relative">
          {/* Landing Section */}
          <div className="landing relative w-full h-full bg-black overflow-hidden">
            {/* Navbar */}
            <div className="navbar absolute top-0 left-0 z-[10] w-full py-5 px-5 sm:py-10 sm:px-10">
              <div className="logo flex gap-4 md:gap-6 items-center">
                ...
                <Image
                  src="/Assets/Rockstar_Games_Logo.png"
                  alt="logo"
                  width={30}
                  height={20}
                />
            ...
            <div className="imagesdiv relative w-full h-full overflow-hidden">
              ...
              {/* 18+ Logo Image */}
                ...
                <Image
                  ...
                  width={50}
                  height={50}
                  className="absolute adult top-1/2 left-[78vw] sm:left-2/3 object-cover"
                />
              ...
              <Image
                ...
                width={800}
                height={800}
                className="character hidden sm:block absolute bottom-0 left-1/2 -translate-x-1/2 mx-100 scale-[1.5] sm:scale-[3] rotate-[-15deg] sm:rotate-[-30deg]"
              />

              {/* Girl Image in Mobile View */}
              <Image
                className="sm:hidden absolute -bottom-12 left-1/2 -translate-x-1/2"
                src="/Assets/girlbg.png"
                alt="character"
                width={360}
                height={360}
          ...
          {/* Second Section */}
          <div className="w-full h-auto sm:h-full flex flex-col sm:flex-row items-center justify-center bg-black p-6 overflow-hidden">
            <div className="cntnr flex flex-col sm:flex-row text-white w-full h-auto sm:h-[80%] gap-5 sm:gap-0">
              ...
              <div className="rg w-full sm:w-[30%] text-center sm:text-start">
                ...
                <button
                  onClick={() => router.push("https://www.rockstargames.com/VI")}
                  className="bg-yellow-500 p-2 sm:p-3 text-black mt-5 sm:mt-10 text-sm sm:text-lg rounded cursor-pointer">
                  Download Now
                </button>
              </div>
            </div>
