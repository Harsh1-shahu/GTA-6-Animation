...
const Page = () => {
  ...
  useEffect(() => {
    ...
    tl.to(".main", {
      ...
      .to(".bg", { scale: 1.1, rotate: 0, duration: 2, delay: "-.4", ease: "expo.inOut" }, "<")
      .to(".character", { scale: 0.7, x: "-50%", bottom: "-60%", rotate: 0, duration: 2, delay: "-.8", ease: "expo.inOut" }, "<")
  ...
  return (
    <>
      ...
      {showContent && (
        <div className="main w-full h-full lg:rotate-[-10deg] lg:scale-[1.7] md:scale-110 scale-100 relative">
          {/* Landing Section */}
          <div className="landing relative w-full h-screen bg-black overflow-hidden">
            ...
            <div className="imagesdiv relative w-full h-screen overflow-hidden">
              {/* Sky Image */}
              <img
                className="absolute sky top-0 left-0 w-full h-full object-cover scale-[1.2] sm:scale-[1.5] rotate-[-15deg] sm:rotate-[-20deg]"
                src="/Assets/sky.png"
                alt="sky"
              />
              {/* Buildings Image */}
              <img
                className="absolute bg top-0 left-0 w-full h-[42rem] sm:h-full object-cover scale-[1.3] sm:scale-[1.8] rotate-[-2deg] sm:rotate-[-3deg]"
                src="/Assets/bg.png"
                alt="background"
              />
              {/* 18+ Logo Image */}
              ...
              {/* Girl Image */}
              <img
                className="absolute character bottom-0 sm:-bottom-[190%] left-1/2 -translate-x-1/2 scale-[1.5] sm:scale-[3] rotate-[-15deg] sm:rotate-[-20deg]"
